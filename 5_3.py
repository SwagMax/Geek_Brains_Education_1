...
tutors = ['Иван', 'Анастасия', 'Петр', 'Сергей','Дмитрий', 'Борис', 'Елена', 'Станислав', 'Max', 'Pol', 'Gvido']
klasses = ['9А', '7В', '9Б', '9В', '8Б', '10А', '10Б', '9А']

rez = (i for i in zip_longest(tutors, klasses) if len(tutors) > len(klasses))

print(type(rez))
print(*islice(rez, 11))
print(list(islice(rez, 3)))